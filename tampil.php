...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">KRS Prediksi</font></center>
		<hr>
		<a href="index.php?page=tambah_mhs"><button class="btn btn-dark right">Tambah Matakuliah</button></a>
